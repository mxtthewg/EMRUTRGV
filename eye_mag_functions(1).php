                                    ...
                                    <li id="menu_fullscreen" name="menu_fullscreen" <?php echo ($fullscreen ?? ''); ?>>
                                        <a class="nav-link black"
                                           ...
                                           <?php 
                                                ...
                                                $encodedURI = htmlspecialchars(rawurlencode($_SERVER['REQUEST_URI']), ENT_QUOTES, 'UTF-8');

                                           ?>


                                           onclick="openNewForm('<?php echo $GLOBALS['webroot']; ?>/interface/patient_file/encounter/load_form.php?formname=fee_sheet');top.restoreSession();dopopup('<?php echo $encodedURI . '&display=fullscreen&encounter=' . $encounter; ?>');"
                                           href="JavaScript:void(0);"
